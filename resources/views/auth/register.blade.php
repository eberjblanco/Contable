...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Por favor llene los siguientes datos</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        @csrf
                         <input type="hidden" name="nivel" id="nivel" value="usuario">
                        <input type="hidden" name="status" id="status" value="habilitado">
